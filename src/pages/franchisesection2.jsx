  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" class="space-y-8">
          ...
          <div>
              ...
              <div>
                  <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Furnishing Area</label>
                  <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"required>
                      <option selected="">Select Carpet Area</option>
                      <option value="Area">40 x 60 Square feet</option>
                      <option value="Area">50 x 70 Square feet</option>
                      <option value="Area">60 x 80 Square feet</option>
                      <option value="Area">70 x 90 Square feet</option>
                  </select>
              </div>
          
          <div class="sm:col-span-2">
              <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your Introduction</label>
